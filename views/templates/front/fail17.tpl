...
<div class="box">
	...
	<br /><br />{l s='For any questions or for further information, please contact our' mod='pensopay'} <a href="{$urls.pages.contact|escape:'javascript':'UTF-8'}">{l s='customer support' mod='pensopay'}</a>.
</div>
{/if}
